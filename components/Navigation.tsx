      ...
      <Transition.Root show={open} as={Fragment}>
        <Dialog as={"div"} className={"relative z-10"} onClose={setOpen}>
          ...
          >
            <div
              className={
                "fiexed inset-0 bg-gray-500 bg-opacity-25 transition-opacity"
              }
            />
          </Transition.Child>
          <div className={"fiexed inset-0 overflow-hidden"}>
            <div className={"absolute inset-0 overflow-hidden"}>
              ...
              >
                <Transition.Child
                  as={Fragment}
                  enter={
                    "transform transition-all ease-in-out duration-500 sm:duration-500"
                  }
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div
                        className={"flex-1 overflow-y-auto px-8 py-6 sm:px-12"}
                      >
                        ...
                        >
                          <div>
                            <Link
                              href={"/conteact"}
                              className={
                                "block text-center text-[11.5px] tracking-[2px] font-bold uppercase bg-violet-600 py-4 px-5 text-white"
                              }
                            >
                              Contact Us Now
                            </Link>
